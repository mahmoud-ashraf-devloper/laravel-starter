...
function UpdateCategoryModal({ setCategories, category, categories }) {
    ...
    useEffect(() => {
        ...
        category.sub_categories.map(category => {
            arrayOfSelectedOptions.push({
                value: category.id,
                label: category.name,
            })
        })
        setSubCategories(arrayOfOptions)
        setSelectedSubCategories(arrayOfSelectedOptions)
    }, [category]);
    ...
    const handleSubmit = (e) => {
        ...
        // console.log(data);
        axios.post(route('admin.categories.update', category.slug),
            data, {
            headers: {
    ...
    return (
        <div id="updateCategoryModal" tabIndex="-1" aria-hidden="true" className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 min-h-full">
            <div className="relative p-4 w-full max-w-2xl h-full md:mt-20 ">
                ...
                <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div className="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                        ...
                        <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="updateCategoryModal">
                        ...
                        <div className="my-4 mt-10 items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                            {
                                loading ?
                                    ...
                                    <button type="submit" className="w-full sm:w-auto justify-center text-white inline-flex bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update Category</button>
                            }
                        </div>
                    </form>
                </div>
