...
function Footer() {
    ...
    return (
        <footer className="relative z-10 bg-white dark:bg-slate-800 border-t-2 mt-20 dark:border-t-slate-600 dark:text-white pt-8 pb-10 lg:pt-14 lg:pb-20">
                            ...
                            <ul>
                                <li>
                                    <Link href="javascript:void(0)"
                                        className="mb-2 inline-block text-base leading-loose text-body-color hover:text-blue-600">
                                        SaaS Development
                                    </Link>
                                </li>
                                <li>
                    ...
                    <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
                        <div className="mb-10 w-full">
                            ...
                            <div className="mb-6 flex items-center">
                                <Link href="javascript:void(0)"
                                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-blue-600 hover:bg-blue-600 hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
