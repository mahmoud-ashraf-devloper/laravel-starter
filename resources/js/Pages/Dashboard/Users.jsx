      ...
      <section className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 antialiased">
        <div className="mx-auto max-w-screen-xl px-4 lg:px-12">
          ...
          <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        ...
                        <td className="px-4 py-3 flex flex-wrap gap-1">
                          {
                            item.roles.map((role, key) => (
                              ...
                              <span key={key}
                                className="bg-blue-400 text-white text-sm px-2 py-1 rounded-full">{role.name}</span>
                            ))
                          }
                        </td>
                        <td className="px-4 py-3 max-w-[12rem] truncate">{item.email}</td>
                        <td className="px-4 py-3 flex flex-wrap gap-1">
                          {/* {
                            user.permissions.map((permission, key) => (

                              <span
                                className="bg-blue-400 text-white text-sm px-2 py-1 rounded-full">{permission.name}</span>
                            ))
                          } */}
                          Stay tuned
            ...
            <Pagination data={users} ziggy={ziggy} />
          </div>
        </div>
      </section>
