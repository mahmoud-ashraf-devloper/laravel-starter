<section class="relative z-10">
    ...
    <div
        class="w-full p-4 py-8 text-center bg-white   sm:p-8 dark:bg-gray-900 ">
        <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Download Our App and Work fast from anywhere
        </h5>
