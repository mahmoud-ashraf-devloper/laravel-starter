...
<footer class="relative z-10 bg-white dark:bg-slate-800 border-t-2 mt-20 dark:border-t-slate-600 dark:text-white pt-8 pb-10 lg:pt-14 lg:pb-20">
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-wrap justify-center">
            <div class="w-full px-4 sm:w-2/3 lg:w-4/12">
                <div class="mb-10 w-full">
                    <a href="/" class="flex items-center mb-14">
                        <div class="w-15 h-15 ">
                    ...
                    <ul>
                        <li>
                            <a href="javascript:void(0)"
                                class="mb-2 inline-block text-base leading-loose text-body-color hover:text-blue-600">
                                SaaS Development
                            </a>
                        </li>
                        <li>
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="mb-10 w-full">
                    ...
                    <div class="mb-6 flex items-center">
                        <a href="javascript:void(0)"
                            class="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-blue-600 hover:bg-blue-600 hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
