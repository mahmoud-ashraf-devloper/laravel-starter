    ...
    <div class="antialiased">
        <div class="py-6">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Breadcrumbs -->
                <div class="max-w-7xl mx-auto sm:px-2 mb-4">
                    <div class="flex items-center space-x-2 text-gray-400 text-sm">
                        ...
                        <a href="{{ route('shop') }}" class="hover:underline hover:text-gray-600">Shop</a>
                ...
                <section
                    class=" grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-10 gap-x-6 mt-10 mb-5">
                    @foreach ($products as $item)
                        <!--   ✅ Product card 1 - Starts Here 👇 -->
                        <div
                            class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl overflow-hidden">
                            <a href="{{ route('product') }}" class="">
                                <img src="{{ $item['images'][3] }}" alt="Product"
                                    class="h-80 w-full object-cover rounded-t-xl  duration-500 hover:scale-105" />
                                <div class="px-4 py-3 w-full">
                                    <span class="text-gray-400 mr-3 uppercase text-xs">Brand</span>
                                    <p class="text-lg font-bold text-black dark:text-white truncate block capitalize">
                                        Product Name</p>
                            ...
                            <div class="flex items-center">
                                <p class="text-lg font-semibold text-black dark:text-white cursor-auto my-3">$149
                                </p>
                                <del>
    ...
    <form action="#" method="get" id="drawer-more-filters"
        ...
        <div class="flex flex-col justify-between flex-1">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between col-span-2 space-x-3">
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" id="max-experience-input" value="3500" min="1"
                                max="10000"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="" required>
                        </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center">
                        <input id="five-stars" type="radio" value="" name="rating"
                            class="w-4 h-4 bg-gray-100 border-gray-300 text-blue-600 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="bottom-0 left-0 flex justify-center w-full pb-4 mt-6 space-x-4 md:px-4 md:absolute">
                <button type="submit"
                    class="w-full px-5 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-700 dark:hover:bg-blue-800 dark:focus:ring-blue-800">
                    Apply filters
                </button>
                <button type="reset"
