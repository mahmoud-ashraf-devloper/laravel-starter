    ...
    <div class="w-full px-6 py-6 mx-auto">
        ...
        <div class="flex flex-wrap -mx-3">
            ...
            <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
                <div
                    class="relative flex flex-col min-w-0 break-words bg-white dark:bg-slate-800 dark:text-white shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    class="flex justify-center items-center w-12 h-12 text-center text-white rounded-lg bg-gradient-to-tl from-blue-700 to-blue-500">
                ...
                <div
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-sm">Orders</p>
                                    <h5 class="mb-0 font-bold">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    class="flex justify-center items-center w-12 h-12 text-center text-white rounded-lg bg-gradient-to-tl from-blue-700 to-blue-500">
                                    <i class="fa-brands fa-first-order fa-lg"></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- card6 -->
            <div class="w-full max-w-full px-3 my-4 sm:w-1/2 sm:flex-none xl:w-1/4">
                <div
                    class="relative flex flex-col min-w-0 break-words bg-white dark:bg-slate-800 dark:text-white shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans font-semibold leading-normal text-sm ">Total Sales</p>
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    class="flex justify-center items-center w-12 h-12 text-center text-white rounded-lg bg-gradient-to-tl from-blue-700 to-blue-500">
                                    <i class="fa-brands fa-adversal fa-lg"></i>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="flex flex-wrap mt-6 -mx-3">
            <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
                <div
                    class="border-black/12.5 shadow-soft-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white dark:bg-slate-800 dark:text-white bg-clip-border">
                    <div class="flex-auto p-4">
            ...
            <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none ">
                <div
                    class="border-black/12.5 shadow-soft-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white dark:bg-slate-800 dark:text-white bg-clip-border">
                    <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white dark:bg-slate-800 dark:text-white p-6 pb-0">
